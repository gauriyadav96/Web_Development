...
var _ = require('lodash'); // for url cases
...
app.post("/compose", function(req,res){
  ...
  posts.push(postSection);
  res.redirect("/");
});

// to go to the respective post which was published on the main page
app.get("/posts/:pname", function(req,res){

const requestedTitle = _.lowerCase(req.params.pname);
